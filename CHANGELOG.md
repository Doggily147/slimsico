...
### Changed
- The console screen is now a tall upright panel facing the rider, and it is live: five readout bars rise and fall on their own rhythms, a scan line sweeps up and down the panel, a ring glyph turns, and the panel's glow pulses, all keyed across the scene.
