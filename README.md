...
- `build_character.py` - run inside Blender with the scene open: adds the smooth matte yellow Human Fall Flat styled crowned character and switches the baseplate to the numbered grid texture.
