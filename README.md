...
- **Purple** lives in `slimsico.blend` (the "Purple" collection), modelled by hand in Blender through the Blender MCP rather than by a script: Yellow's rig cloned and tinted purple, Yellow's own face with a straight mouth instead of the smile, a flat leather shoulder strap over the right shoulder ball and across the chest, a belt with a brass buckle and a gear pouch on the left hip, and two debug katanas carried tip-down across his back: curved single-edged green blades with a ridge, a bright edge, an angled tip and glowing binary etched on both flats, a pierced round guard, a criss-cross wrapped grip and an end cap with a small gem. Everything is bone-parented so the animation scripts drive him unchanged. Hidden from render until the story needs him.
